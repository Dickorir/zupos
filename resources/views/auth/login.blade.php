  ...
  <div class="login-box-body">
    ...
    <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
      ...
      <div class="form-group has-feedback">
        <input id="email" type="email" class="jQKeyboard form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus placeholder="Email">
      ...
      <div class="form-group has-feedback">
        <input id="password" type="password" class="jQKeyboard form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required placeholder="Password">
