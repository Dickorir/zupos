                ...
                <div class="box">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs pull-left bg-light-blue-gradient">
                            <li class=""><a href="#new_orders" id="new_ords">New Orders <span class="label label-success info" id="info">{{ count($orders) }}</span></a></li>
                            <li><a href="#sales_today" id="salestoday">Sales Today <span class="label label-warning warning">{{ count($salestoday) }}</span></a></li>
                        </ul>
